...
set_property PACKAGE_PIN M4 [get_ports {s[3]}]
set_property PACKAGE_PIN N7 [get_ports {s[1]}]
...
set_property PACKAGE_PIN M2 [get_ports {s[2]}]
set_property PACKAGE_PIN M7 [get_ports {s[0]}]